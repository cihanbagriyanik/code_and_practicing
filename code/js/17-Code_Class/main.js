...
const aranacaklar = yeniListe.filter((a) => a.name[0] === "E").map((a) => {
  return {
    name: a.name,
    phone: a.phone,
  }
})
console.log("Pazartesi Aranacaklar", aranacaklar);

const aranacaklar1 = yeniListe.filter((a) => a.name[0] === "C").map((a) => {
  return {
    name: a.name,
    phone: a.phone,
  }
})
console.log("Carsamba Aranacaklar", aranacaklar1);
...
//* ID-AD ve MAIL adresli yeni liste
const yeniListe2 = customerList.map((a) => {
  return {
    id: a.id,
    name: a.name,
    phone: a.email,
...
console.log(yeniListe2);
/* -------------------------------------------------------------------------- */
//* ID si TEK olanalarin dokumu ve mesaji
const idTek = yeniListe2.filter((x) => x.id % 2 !== 0).map((a) => {
  return {
    name: a.name,
    phone: a.phone,
...
console.log(idTek);
/* -------------------------------------------------------------------------- */
//* ID si CIFT olanalarin dokumu ve mesaji
const idCift = yeniListe2.filter((x) => x.id % 2 === 0).map((a) => {
  return {
    name: a.name,
    phone: a.phone,
