...
import { usePostBrandMutation, useUpdateBrandMutation } from "../../services/brands";
...
export default function BrandModal({ open, handleClose, info }) {
  const [updateBrand] = useUpdateBrandMutation()
  const [postBrand] = usePostBrandMutation()
  const handleSubmit = info => {//! handleSubmit diye bir fonksiyon tanımlayıp formike bu fonksiyıonu verdik. Formikten gelen valuesu böylelikle yakaladık.
    if (info._id) {
